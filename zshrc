...
export BULLETTRAIN_PROMPT_ORDER=(time status custom context dir virtualenv aws go git cmd_exec_time)
...
export LOCAL_BIN=/home/vagrant/.local/bin

export PATH=$PATH:$FZF_BASE:$LOCAL_BIN
